        ...
        $content='<div id="calendar'.$id.'" '.$display.'>
                    <div id="calendar">'.
                        ...
                        '<div class="box-content ">'.
                                ...
                                $content.='<ul class="dates rounded">';    
        ...
        return '<a 
                ...
                >
                    <li
                        ...
                        class="remove"
                    >
                    <img src="seta-esquerda.svg" style = "width: 40px; height:35px;/>
            ...
            $content.='
                ...
                >
                    ...
                    class="'.($label==6?'end':'start').' title bt-dia-semana">
                        '.$label.' <img src="seta-esquerda.svg" style = "width:10px; height:15px;  transform: rotate(90deg)"/>
                    </li>
                <a>
            ';
